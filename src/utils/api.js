...
// Branches
export const getBranches  = (companyId) => api.get('/branches', { params: { company_id: companyId } });
...
// Messages
export const getMessages  = (type, id, params) => api.get(`/messages/${type}/${id}`, { params });
export const sendMessage  = (data)              => api.post('/messages', data);
export const uploadFile   = (formData)          => api.post('/messages/upload', formData, { headers: { 'Content-Type': 'multipart/form-data' } });
...
export const setReminderStatus = (id, status) => api.patch(`/reminders/${id}/status`, { status });
